...
Write-Host "Installing Python.Python.3"
winget install Python.Python.3 | Out-Host
if($?) { Write-Host "Installed Python.Python.3" }

Write-Host "Installing Git.Git"
winget install Git.Git | Out-Host
if($?) { Write-Host "Installed Git.Git" }

Write-Host "Installing ShareX.ShareX"
winget install ShareX.ShareX | Out-Host
if($?) { Write-Host "Installed ShareX.ShareX" }

Write-Host "Installing Barrier"
winget install DebaucheeOpenSourceGroup.Barrier | Out-Host
if($?) { Write-Host "Installed Barrier" }

Write-Host "Installing ZeroTierOne"
winget install ZeroTier.ZeroTierOne | Out-Host
if($?) { Write-Host "Installed ZeroTierOne" }
